 ...
 * @Describe: 该类主要用于提供模拟日志的发送
 */
import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.shenzhenhua.utils.{SendLog, RandomNumUtil, RandomOptions}
...
object JsonDatasource {
  ...
  def initOneStartupLog(): String = {
    ...
    val mid: String = "mid_" + RandomNumUtil.randomInt(1, 10)
                      // TODO 设备数,做实时预警时调小(1,10)，做日活日志时调大(1,500)
    val uid: String = "uid_" + RandomNumUtil.randomInt(1, 100)*RandomNumUtil.randomInt(1, 100)
